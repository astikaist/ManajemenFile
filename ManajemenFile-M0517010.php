...
// set true agar terdapat halaman login (user dan password). set false untuk menghilangkan halaman login
$use_auth = true;

// set array untuk 'username'=>'password'
$auth_users = array('admin123' => 'admin123',);

// mengaktifkan highlight
...
/**
zona waktu date & time file/ folder yang ditampilkan adalah Asia/jakarta
pengaturan zona waktu dapat dilihat di : http://php.net/manual/en/timezones.php
**/
$default_timezone = 'Asia/jakarta'; // UTC+3

// Root path file manager
$root_path = $_SERVER['DOCUMENT_ROOT'];

/**
Root url pada file. miaslnya, PEMWEB/StaticWeb/index.html
jika $root_path diluar server document root, maka perintah $root_url tidak akan bekerja
**/
$root_url = '';

// Server hostname. dapat disetting manual jika salah
$http_host = $_SERVER['HTTP_HOST'];

// memasukkan encoding untuk iconv
$iconv_input_encoding = 'CP1251';

// format date & time adalah d.m.y H:i
...
$cookie_name = "cookie";
$cookie_value = "ini cookie";
setcookie($cookie_name, $cookie_value, time() + (86400), "/");

// membersihkan dan cek $root_path
...
// gunakan ?p= setiap kali loading/ redirect
if (!isset($_GET['p'])) {
    fm_redirect(FM_SELF_URL . '?p=');
}
...
// Hapus beberapa file/ folder secara bersamaan
...
// Membuat folder
if (isset($_GET['new'])) {
    $new = strip_tags($_GET['new']); // hapus karakter yang tidak sesuai saat membuat nama folder
...
// copy beberapa file/ folder secara bersamaan
...
<td><span class="salmon" title="<?php printf('%s bytes', $filesize_raw) ?>"><?php echo $filesize ?></span></td>
...
<?php
    ...
    ?>
<tr><td class="salmon"></td><td class="salmon" colspan="<?php echo !FM_IS_WIN ? '6' : '4' ?>">
 ...
 * @param bool $force membuat folder/file yang sama
 * @return bool
 */
...
html{
	...
	color:#222;
	background : url(http://getwallpapers.com/wallpaper/full/8/2/3/974053-top-maroon-color-background-1920x1080-smartphone.jpg);
	}
...
<body>
<div id="wrapper">
<h1 style="color:#d3d3d3;"><center>MANAJEMEN FILE</center></h1>
<?php
}
...
{
    ?>
<p class="center"><small>Manajemen File-Astika Istiningrum</small></p>
</div>
<script>
